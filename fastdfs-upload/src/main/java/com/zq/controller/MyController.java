...
import com.zq.pojo.HouseInfo;
import com.zq.service.HouseInfoService;
import com.zq.utils.FastDFSUtils;
...
public class MyController {
    ...
    public String upload(@RequestParam("file") MultipartFile file){//MultipartFile
        try{
            ...
            FastDFSUtils fastDFSUtils = new FastDFSUtils("client.conf");

            String s [] =  fastDFSUtils.uploadFile(b,suffix);

            StringBuilder stringBuilder = new StringBuilder("http://192.168.80.100:82/");
            if (s!=null){
                //  group1
